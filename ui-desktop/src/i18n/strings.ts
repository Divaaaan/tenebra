...
const en: Strings = {
  ...
  blocklist: {
    ...
    loading: "Reading…",
    badFile: "Unsupported file. Expected an archive or a text list.",
    rules: "rules",
    counting: "reading…",
    remove: "Remove",
    close: "Close",
    ...
    helpLines: [
      ...
      "Drop the archive exactly as downloaded, or a plain text list.",
      "Lines may be bare domains, hosts entries (0.0.0.0 ads.example),",
      "AdBlock syntax (||ads.example^) or a JSON rule-set — all are understood.",
...
const ru: Strings = {
  ...
  blocklist: {
    ...
    loading: "Читаю…",
    badFile: "Такой файл не подойдёт. Нужен архив или текстовый список.",
    rules: "правил",
    counting: "читаю…",
    remove: "Убрать",
    close: "Закрыть",
    ...
    helpLines: [
      ...
      "Перетащи архив прямо как скачал — распаковывать не надо. Или обычный текстовый список.",
      "Понимаются: голый домен, hosts (0.0.0.0 ads.example),",
      "AdBlock (||ads.example^) и JSON-правила — разбирается любой формат.",
